(() => {
  ...
  if (window.__monCarnetCoursesV251) return;
  window.__monCarnetCoursesV251 = true;
  ...
  function adaptExistingInterface() {
    document.title = 'Mon Carnet V2.5.1 TEST';
    setTextIfChanged($('.brand small'), 'VERSION · V2.5.1 TEST');
