(() => {
  ...
  if (window.__monCarnetCoursesV109) return;
  window.__monCarnetCoursesV109 = true;
  ...
  function injectStyles() {
    ...
    style.textContent = `
      ...
      .mc-course-item details{margin:8px 0 0 32px}.mc-course-item summary{cursor:pointer;color:var(--forest);font-size:13px;font-weight:700}.mc-course-item details p{margin:5px 0 0;font-size:13px}.mc-course-adjusted{color:var(--copper);font-weight:700}
