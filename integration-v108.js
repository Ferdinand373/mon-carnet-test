(() => {
  ...
  if (window.__monCarnetCoursesV108) return;
  window.__monCarnetCoursesV108 = true;
  ...
  function injectStyles() {
    ...
    style.textContent = `
      ...
      @media(max-width:680px){.mc-course-manual-grid,.mc-product-create-grid{grid-template-columns:1fr}.mc-course-manual-grid .btn,.mc-product-create-grid .btn{width:100%}.mc-products-actions .btn{flex:1 1 100%}}
    `;
