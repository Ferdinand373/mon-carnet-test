(() => {
  ...
  if (window.__monCarnetCoursesV112) return;
  window.__monCarnetCoursesV112 = true;
  ...
  async function exportFullBackup(event) {
    ...
    try {
      ...
      link.href = url;
      link.download = `mon-carnet-complet-${backupDateStamp()}.json`;
